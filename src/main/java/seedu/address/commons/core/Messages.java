...
public class Messages {
    ...
    public static final String MESSAGE_TUTORS_LISTED_OVERVIEW = "%1$d tutor(s) listed!";
    ...
    public static final String MESSAGE_INVALID_INPUT_STUDENT_WITH_QUALIFICATION = "Students do not have any"
            + " qualifications tagged to them!";
}
